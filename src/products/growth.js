PRODUCTS.growth = {
  id:'growth',
  tag:'02',
  name:'Марафон роста / внутренний кейс-чемпионат',
  ...
  hasROI:true,
  inputs:[
    {id:'participantsCount', label:'Количество участников проекта', unit:'чел.', def:100, group:'main', step:1},
    {id:'participantSalary', label:'Средняя зарплата участника', unit:'₽/мес', def:150000, group:'main', step:1000},
    {id:'programCost', label:'Стоимость проекта Changellenge >>', unit:'₽', def:16000000, group:'main', step:100000},

    {id:'rdParticipantsCount', label:'Сотрудников, работающих над бизнес-задачей', unit:'чел.', def:50, group:'advanced', step:1},
    ...
    {id:'aiParticipantsCount', label:'Сотрудников, повышающих эффективность за счёт ИИ', unit:'чел.', def:50, group:'advanced', step:1}
  ],
  compute(v){
    ...
    const rdFot = v.participantSalary*TAX*v.rdParticipantsCount;
    const rdHoursCost = rdFot*RD_HOURS/HOURS_MONTH;
    const rdTotalCost = rdHoursCost+v.programCost+TEAM_COST;
    ...
    const aiFot = v.participantSalary*TAX*v.aiParticipantsCount;
    const e4 = aiFot*AI_SAVE*AI_SHARE;

    const total = e1+e2+e3+e4;
    const cost = rdTotalCost;
      ...
      effects:[
        {id:'e1', label:'Рост эффективности участников', amount:e1,
          ...
          data:[
            ...
            {k:'Рост эффективности по итогам проекта (фиксированный показатель модели)', v:fmtPercent(effGain,1)}
          ],
        ...
        {id:'e4', label:'Эффект от роста эффективности использования ИИ', amount:e4,
          ...
          data:[
            {k:'Расход на ФОТ сотрудников, применяющих ИИ (месяц)', v:fmtMoneyFull(aiFot)},
