PRODUCTS.growth = {
  ...
  periodNote:'Эффекты продуктивности и ИИ рассчитаны за один месяц; итог объединяет периоды, как в Excel.',
  modelNote:'Для R&D и затрат используются отдельные стоимости проекта: 16 и 6 млн ₽ по умолчанию. ROI в Excel назван годовым, но месячные эффекты продуктивности и ИИ не умножаются на 12. Множитель R&D — 1,25, дополнительное деление из комментария не применяется.',
  inputs:[
