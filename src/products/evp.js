PRODUCTS.evp = {
  ...
  modelNote:'Индекс аутентичности — понижающий коэффициент для активации, который уменьшает рассчитанный экономический эффект, чтобы сделать оценку более реалистичной.',
  inputs:[
    ...
    return {
      ...
      effects:[
        ...
        {id:'e4', label:'Эффект от разработки EVP', amount:developmentEffect,
          ...
          source:'Оценка стоимости ошибки 30% — по данным SHRM / BLS и CertifiedSource (2026); снижение вероятности на 10% — консервативная экспертная оценка на основе исследований соответствия сотрудника работе и организации и данных Gallup.'
        }
      ],
      costBreakdown:[
